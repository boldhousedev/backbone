...
obj.setDefaults = function (attrs) {
    var defaults = this.createJsonStack(_.result(this, "defaults") || {});

    var o = _.defaults2(_.clone2(attrs), defaults);
    for (var x in o) {
        this.set(x, o[x]);
    }
};
...
obj.createJsonKey = function (k, o, v) {
    if (!k) return v;
        ...
        // /^[0-9]+$/.test(x) && (o = []);
        // the solution above will in fact solve your problem with {0: ..., 1: ...}
        // but what will you do when you have {3: ...} that will become [...]
        // making you lose your key that is essential to your validations, and multiple inner fields?
